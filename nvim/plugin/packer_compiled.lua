...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["friendly-snippets"] = {
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["lsp-zero.nvim"] = {
    config = { "require('setup/lsp-zero')" },
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["nvim-base16"] = {
    ...
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/nvim-base16",
  ...
  ["nvim-comment"] = {
    ...
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  ["spellsitter.nvim"] = {
    config = { "require('setup/spellsitter')" },
    loaded = true,
    path = "/Users/daniel/.local/share/nvim/site/pack/packer/start/spellsitter.nvim",
